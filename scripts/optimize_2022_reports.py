...
# 上海海港2022一线队大名单（基于号码和拼音）
SHANGHAI_PORT_2022_ROSTER = {
    # 门将
    1: {"name": "颜骏凌", "pinyin": "Yan Junling"},
    12: {"name": "陈威", "pinyin": "Chen Wei"},
    22: {"name": "杜佳", "pinyin": "Du Jia"},
    41: {"name": "奚安杰", "pinyin": "Xi Anjie"},
    43: {"name": "梁锟", "pinyin": "Liang Kun"},
    
    # 后卫
    2: {"name": "李昂", "pinyin": "Li Ang"},
    3: {"name": "蒋光太", "pinyin": "Tyias Browning"},
    4: {"name": "王燊超", "pinyin": "Wang Shenchao"},
    5: {"name": "张琳芃", "pinyin": "Zhang Linpeng"},
    7: {"name": "魏震", "pinyin": "Wei Zhen"},
    ...
    35: {"name": "张慧宇", "pinyin": "Zhang Huiyu"},
    39: {"name": "刘柏杨", "pinyin": "Liu Baiyang"},
    40: {"name": "吕坤", "pinyin": "Lyu Kun"},
    44: {"name": "向荣峻", "pinyin": "Xiang Rongjun"},
    45: {"name": "王玉龙", "pinyin": "Wang Yulong"},
    46: {"name": "汤宇璇", "pinyin": "Tang Yuxuan"},
    34: {"name": "赵申澳", "pinyin": "Zhao Shen'ao"},
    35: {"name": "杨子涵", "pinyin": "Yang Zihan"},
    
    # 中场
    6: {"name": "蔡慧康", "pinyin": "Cai Huikang"},
    8: {"name": "奥斯卡", "pinyin": "Oscar"},
    9: {"name": "保利尼奥", "pinyin": "Paulinho"},
    10: {"name": "马蒂亚斯·巴尔加斯", "pinyin": "Matías Vargas"},
    11: {"name": "吕文君", "pinyin": "Lü Wenjun"},
    14: {"name": "李圣龙", "pinyin": "Li Shenglong"},
    15: {"name": "李申圆", "pinyin": "Li Shenyuan"},
    16: {"name": "徐新", "pinyin": "Xu Xin"},
    17: {"name": "陈彬彬", "pinyin": "Chen Binbin"},
    25: {"name": "买提江", "pinyin": "Mirahmetjan Muzepper"},
    26: {"name": "陈纯新", "pinyin": "Chen Chunxin"},
    27: {"name": "冯劲", "pinyin": "Feng Jing"},
    29: {"name": "张华晨", "pinyin": "Zhang Huachen"},
    33: {"name": "刘祝润", "pinyin": "Liu Zhurun"},
    37: {"name": "陈旭黄", "pinyin": "Chen Xuhuang"},
    44: {"name": "王逸伟", "pinyin": "Wang Yiwei"},
    27: {"name": "阿布拉汗·哈力克", "pinyin": "Ablahan Haliq"},
    
    # 前锋
    7: {"name": "武磊", "pinyin": "Wu Lei"},
    10: {"name": "恩迪亚耶", "pinyin": "Cherif Ndiaye"},
    33: {"name": "刘祝润", "pinyin": "Liu Zhurun"},
    36: {"name": "卡隆", "pinyin": "Issa Kallon"},
    38: {"name": "黎德明", "pinyin": "Li Deming"},
    39: {"name": "王淞", "pinyin": "Wang Song"},
}
...
def find_player_by_number(number: int) -> Optional[Dict]:
    """根据号码查找球员"""
    return SHANGHAI_PORT_2022_ROSTER.get(number)

def find_player_by_pinyin(name: str) -> Optional[Dict]:
    """根据拼音查找球员"""
    normalized_name = normalize_pinyin(name)
    
    for number, player_info in SHANGHAI_PORT_2022_ROSTER.items():
